...
from mypattern.pattern.text import (
...
from mypattern.pattern.text.tree import (
...
from mypattern.pattern.text.en.inflect import (
...
from mypattern.pattern.text.en.inflect_quantify import (
    number, numerals, quantify, reflect
)
# Import mood & modality functions.
from mypattern.pattern.text.en.modality import (
    mood, INDICATIVE, IMPERATIVE, CONDITIONAL, SUBJUNCTIVE,
    modality, uncertain, EPISTEMIC,
    negated
)
# Import all submodules.
from mypattern.pattern.text.en import inflect
from mypattern.pattern.text.en import wordnet
from mypattern.pattern.text.en import wordlist
